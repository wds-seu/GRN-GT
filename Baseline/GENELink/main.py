...
for run in range(T):
    ...
    exp_file = os.getcwd() + '/Dataset/' + args.net + ' Dataset/' + args.data + '/TFs+' + str(
        args.num) + "/BL--ExpressionData.csv"
    tf_file = os.getcwd() + '/Dataset/' + args.net + ' Dataset/' + args.data + '/TFs+' + str(args.num) + '/TF.csv'
    target_file = os.getcwd() + '/Dataset/' + args.net + ' Dataset/' + args.data + '/TFs+' + str(
        args.num) + '/Target.csv'
...
print("mean AUROC:%.4f, AUPRC:%.4f" % (mean1 / T, mean2 / T))
