from grnn import GraphRecurrentNetwork
...
class TransorfomerModel:
    def __init__(self, exp, do_train = False):
        ...
        if self.do_train:
            ...
            with tf.name_scope('input_train'):
                self.encoded_gene = tf.compat.v1.placeholder(dtype=tf.float32, shape=(self.num_nodes, self.num_Cells))
    ...
    def inference(self):
        ...
        self.model = GraphRecurrentNetwork(
